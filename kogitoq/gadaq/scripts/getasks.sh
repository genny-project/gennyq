...
curl   -H "Content-Type: application/json"  -H "Accept: application/json" -X GET http://alyson2.genny.life:${port}/workitemhelper/questions/${GENNY_REALM:internmatch}/QUE_PROJECT_SIDEBAR_GRP/PER_086CDF1F-A98F-4E73-9825-0A4CFE2BB943/PER_086CDF1F-A98F-4E73-9825-0A4CFE2BB943
