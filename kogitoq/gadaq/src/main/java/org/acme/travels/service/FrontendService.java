...
public class FrontendService {
    ...
    public void sendQuestions(final String questionCode, final String sourceCode,
        ...
        log.info("UserToken = " + userToken.getToken());
        ...
        if (source == null) {
            ...
            source = beUtils.getBaseEntityByCode(userToken.getUserCode());
            if (source == null) {
                log.error("Source BE not found for userToken sourceCode" + userToken.getUserCode());
    ...
    public BaseEntity setupProcessBE(final String targetCode, final BaseEntity processBE,
        ...
        // Force the realm
        processBE.setRealm(userToken.getRealm());
