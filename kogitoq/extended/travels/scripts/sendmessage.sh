...
curl  -H "Content-Type: application/json" --header "Authorization: Bearer $TOKEN"  -H "Accept: application/json" -X POST http://alyson.genny.life:9580/messages?businessKey=123 -d @- << EOF
{   
