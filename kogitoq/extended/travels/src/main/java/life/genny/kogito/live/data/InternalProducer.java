...
/**
 * InternalProducer --- Kafka smalltye producer objects to send to internal
 * consumers backends
...
public class InternalProducer {
    ...
    @Inject
    @Channel("search_dataout")
    Emitter<String> searchData;
