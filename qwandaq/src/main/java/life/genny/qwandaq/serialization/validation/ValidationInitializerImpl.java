...
public class ValidationInitializerImpl implements SerializationContextInitializer {

	@Override
	public String getProtoFileName() {
		return "validation-persistence.proto";
	}
	...
	public void registerMarshallers(SerializationContext serCtx) {
		serCtx.registerMarshaller(new ValidationMessageMarshaller());
	}
