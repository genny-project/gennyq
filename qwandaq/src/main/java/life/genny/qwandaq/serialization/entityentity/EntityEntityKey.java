...
public class EntityEntityKey implements CoreEntityKey {
	...
	// No-arg constructor
	public EntityEntityKey() { }

	public EntityEntityKey(String realm, String baseEntityCode, String attributeCode) {
		this.realm = realm;
	...
	@Override
	public EntityEntityKey fromKey(String key) {
		String[] args = key.split(getDelimiter());
		return new EntityEntityKey(args[0], args[1], args[2]);
	}
	@Override
