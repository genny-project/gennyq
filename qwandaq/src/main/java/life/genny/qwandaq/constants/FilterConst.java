...
public class FilterConst {
    ...
    /* Caching */
    public static final String SBE_PREF = "SBE_";
    ...
    public static final String LAST_ANSWERS_MAP = "LAST_ANSWERS_MAP";
    public static final String LAST_SBE_TABLE = "LAST_SBE_TABLE";
