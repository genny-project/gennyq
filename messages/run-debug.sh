...
export KEYCLOAK_AUTH_URL=https://keycloak-testing.gada.io/auth
...
./mvnw clean quarkus:dev -Dquarkus.http.port=10130 -DskipTests=true -Dinfinispan.client.hotrod.server_list=10.123.123.123:11222 -Dinfinispan.client.hotrod.client_intelligence=BASIC